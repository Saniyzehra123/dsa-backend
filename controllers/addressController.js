...
//     const { customer_id, city, address, state, pincode, country, landmark, mobile, email, firstname, lastname, isbilling, birthdate, gender } = req.body;

//     // Check if required fields are missing
//     if (!customer_id || !city || !address || !state || !pincode || !country || !firstname || !lastname || !birthdate || !gender) {
//         return next(new ApiError(400, 'Missing required fields.'));
//     }

//     const query = `
//         INSERT INTO customers_address 
//         (customer_id, city, address, state, pincode, country, landmark, mobile, email, firstname, lastname, isbilling, birthdate, gender) 
//         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
//     `;
...
//     try {
//         db.query(query, [customer_id, city, address, state, pincode, country, landmark || null, mobile, email, firstname, lastname, isbilling, birthdate, gender], (err, result) => {
//             if (err) {
